...
In all probablity, this entire system could be run off kaltura's svn.  Sinatra is probably not needed once the javascripts for monitoring the kdp are implemented.
