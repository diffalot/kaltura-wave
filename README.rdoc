...
Kaltura-Wave is a google wave widget that embeds a KDP in a wave and shares the playstate of the KDP via javascript.

The server system that serves the kdps to the waves is run on Sinatra.
